...
**CRITICAL:** Do NOT include parameter details per CONTEXT.md decision: "Report entries show name and purpose only -- no parameter details."
  ...
  - Grep for each domain skill name in the catalog's Coverage column to confirm key_links are wired:
    - "control-erp-financial" must appear (5 Financial Reports)
    - "control-erp-production" must appear (3 WIP Reports)
    - "control-erp-sales" must appear (10+ Sales Reports)
    - "control-erp-customers" must appear (3+ reports: By Customer Volume/Frequency, Last Order Aging)
    - "control-erp-inventory" must appear (4 Inventory & Product Reports)
    - "control-erp-core" must appear (2 Estimate Reports)
  </verify>
