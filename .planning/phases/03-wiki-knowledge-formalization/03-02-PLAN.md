...
1. Lists all 95 Macro Message Types in a clean table: ID | Name | NeedsAltID | AltID Description
2. Lists all 10 RuleAction types with ClassTypeIDs: Type | ClassTypeID | Description
...
Verify `output/wiki/references/macro-automation-reference.md` exists and contains "95" (message types), "RuleAction", and at least 5 ClassTypeIDs (23100, 23200, 23300, 23400, 23500).
  </verify>
